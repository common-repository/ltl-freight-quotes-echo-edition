...
namespace EnEchoWarehouse;

/**
 * Generic class to handle warehouse data.
 * Class EnEchoWarehouse
 * @package EnEchoWarehouse
 */
if (!class_exists('EnEchoWarehouse')) {
    ...
    class EnEchoWarehouse
    {
         ...
         */
        public static function get_data($en_location_details = [], $limit = false)
        {
            global $wpdb;
            ...
            isset($limit) && $limit ? $en_where_clause_str .= ' LIMIT 1' : '';
        ...
        public function create_table($network_wide = null)
        {
            if (is_multisite() && $network_wide) {
                foreach (get_sites(['fields' => 'ids']) as $blog_id) {
                    ...
                    $echo_origin_markup = $wpdb->get_row("SHOW COLUMNS FROM " . $en_table_name . " LIKE 'origin_markup'");
                    if (!(isset($echo_origin_markup->Field) && $echo_origin_markup->Field == 'origin_markup')) {
