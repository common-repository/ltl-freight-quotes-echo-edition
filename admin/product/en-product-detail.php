...
namespace EnEchoProductDetail;

use EnEchoWarehouse\EnEchoWarehouse;

/**
 * Add and show simple and variable products.
 * Class EnEchoProductDetail
 * @package EnEchoProductDetail
 */
if (!class_exists('EnEchoProductDetail')) {
    ...
    class EnEchoProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnEchoProductDetail constructor.
         */
        public function __construct()
        {
            ...
            if (!has_filter('En_Plugins_dropship_filter') &&
                ...
                $this->en_echo_product_check_if_woo_payment_and_subscription_plugin_installed();
                // Add simple product fields
                add_action('woocommerce_product_options_shipping', [$this, 'en_show_product_fields'], 9, 3);
                add_action('woocommerce_process_product_meta', [$this, 'en_save_product_fields'], 101, 1);

                // Add variable product fields.
                add_action('woocommerce_product_after_variable_attributes', [$this, 'en_show_product_fields'], 9, 3);
        ...
        {
            $dropship = EnEchoWarehouse::get_data(['location' => 'dropship']);
            $en_dropship_list = [];
...
//      We can use hook for add new product field from other plugin add-on
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("echo_plans_notification_link", [2, 3]);
         ...
         */
        public function en_echo_product_check_if_woo_payment_and_subscription_plugin_installed()
        {
            $all_plugins = apply_filters('active_plugins', get_option('active_plugins'));
