 ...
 * Class EnEchoProductNestingDetail
 * @package EnEchoProductNestingDetail
 */
if (!class_exists('EnEchoProductNestingDetail')) {
    ...
    class EnEchoProductNestingDetail
    {
        ...
        /**
         * Hook for call.
         * EnEchoProductNestingDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_echo_freight_plan_status'], 10, 1);
            ...
            $this->echo_check_if_woo_payment_and_subscription_plugin_installed();
         ...
         * @return array
         */
        public function en_echo_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes - Echo Edition';

            // Nesting plan status
            $plan_required = '0';
            $nesting_status = $en_plugin_name . ': Enabled.';
            $nesting = apply_filters("echo_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting)) {
                $plan_required = '1';
                $nesting_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['echo_freight'][] = 'echo_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['nesting'])) {
                if (!in_array(0, $plan_status['nesting']['plan_required'])) {
                    ...
                    $this->nesting_plan_required = apply_filters("echo_plans_notification_link", [3]);
         ...
         */
        public function echo_check_if_woo_payment_and_subscription_plugin_installed()
        {
