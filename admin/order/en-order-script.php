...
namespace EnEchoOrderScript;

/**
 * Script for send ajax request.
 * Class EnEchoOrderScript
 * @package EnEchoOrderScript
 */
if (!class_exists('EnEchoOrderScript')) {
    ...
    class EnEchoOrderScript
    {
         ...
         * EnEchoOrderScript constructor.
         */
        public function __construct()
        {
            add_action('admin_print_scripts', [$this, 'en_echo_order_script'], 50);
        }

        public function en_echo_order_script()
        {
            global $post;
            ?>
                    ...
                    let data =
                        {
                            ...
                            'action': 'en_echo_admin_order_quotes'
                        };
                    jQuery.ajax({
                        type: "POST",
                        url: ajaxurl,
