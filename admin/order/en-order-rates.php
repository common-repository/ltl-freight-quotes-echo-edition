...
namespace EnEchoOrderRates;

/**
 * Order page rates.
 * Class EnEchoOrderRates
 * @package EnEchoOrderRates
 */
if (!class_exists('EnEchoOrderRates')) {

    class EnEchoOrderRates {

        /**
         * Hook in ajax handlers.
         * EnEchoOrderRates constructor.
         */
        public function __construct() {
            add_action('wp_ajax_nopriv_en_echo_admin_order_quotes', array($this, 'en_echo_admin_order_quotes'));
            add_action('wp_ajax_en_echo_admin_order_quotes', array($this, 'en_echo_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_echo_admin_order_quotes() {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnEchoShippingRates();
