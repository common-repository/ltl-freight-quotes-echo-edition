...
namespace EnEchoDropshipTemplate;

use EnEchoWarehouse\EnEchoWarehouse;

if (!class_exists('EnEchoDropshipTemplate')) {

    class EnEchoDropshipTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            $en_dropship_list = EnEchoWarehouse::get_data(['location' => 'dropship']);
