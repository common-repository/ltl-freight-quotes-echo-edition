...
//      We can use hook for add new location field from other plugin add-on
            return apply_filters('en_echo_add_location', $en_location_data);
        }
        ...
        static public function en_arrange_location_table_row($en_location_list, $en_data, $location_bol, $disabled_plan = '') {
            ...
            foreach ($en_location_list as $key => $location) {
                ...
                echo '<a href="javascript(0)" onclick="return en_echo_location_edit(event, this,' . $location_bol . ')"> <img src = "' . EN_ECHO_DIR_FILE . '/admin/tab/location/assets/images/edit.png" title = "Edit" ></a>';
                echo '<a href="javascript(0)" onclick="return en_echo_location_delete(event, this,' . $location_bol . ' , ' . $en_location_id . ')"> <img  src = "' . EN_ECHO_DIR_FILE . '/admin/tab/location/assets/images/delete.png" title = "Delete" ></a>';
                echo '</td>';
        ...
        static public function en_load() {
            ...
            <div class="confirmation_location_delete en_popup_location_overly">
                <div class="en_popup_location_form en_hide_popup_location">
                    ...
                    <div class="en_confirmation_buttons">
                        <a href="#" class="button-primary en_location_cancel_delete"> <?php _e("Cancel", 'eniture-technology'); ?> </a>
                        <a href="#" class="button-primary en_location_confirm_delete"> <?php _e("OK", 'eniture-technology'); ?> </a>
                    </div>
                </div>
            </div>
            ...
            echo '<input type="submit" value="Save" class="en_echo_location_btn button-primary">';
            echo '</form>';
            echo '</div>';
            echo '</div>';

            echo \EnEchoWarehouseTemplate\EnEchoWarehouseTemplate::en_load();
            echo \EnEchoDropshipTemplate\EnEchoDropshipTemplate::en_load();
        }
