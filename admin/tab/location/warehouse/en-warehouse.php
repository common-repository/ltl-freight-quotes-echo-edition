...
namespace EnEchoWarehouseTemplate;

use EnEchoWarehouse\EnEchoWarehouse;

if (!class_exists('EnEchoWarehouseTemplate')) {

    class EnEchoWarehouseTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            self::$en_warehouse_list = EnEchoWarehouse::get_data(['location' => 'warehouse']);
            ...
            <p><?php _e('Warehouses that inventory all products not otherwise identified as drop shipped items. The warehouse closest to the shopper will be used to retrieve shipping rate estimates.', 'eniture-technology'); ?></p>
